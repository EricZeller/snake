# Snake game
**Name:** Christian Wolter && Gabriel Berchmann @ Sybit GmbH

**Category:** Canvas HTML5, Javascript, Cascading Style Sheets, C++, C#, Java, Node.js, Python, Spring Boot and Thymeleaf with MySQL Database

**Date:** November 1815 @ the first steam machine in england
----------------------------------------------------------------------
